        ...
        <div className="fixed bottom-4 sm:bottom-6 right-4 sm:right-6 z-50 flex flex-col items-end gap-2 sm:gap-3">
            ...
            <div className="inline-flex items-center gap-1.5 sm:gap-2 px-3 sm:px-5 py-2 sm:py-3 rounded-full bg-white dark:bg-card border border-border shadow-lg">
                <div className="relative">
                    <div className="w-2 sm:w-3 h-2 sm:h-3 bg-terracotta rounded-full"></div>
                    <div className="absolute inset-0 w-2 sm:w-3 h-2 sm:h-3 bg-terracotta rounded-full animate-ping"></div>
                </div>
            ...
            <a
                ...
                aria-label="WhatsApp"
                className="w-14 h-14 sm:w-16 sm:h-16 rounded-full bg-terracotta hover:bg-terracotta/90 shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-110 flex items-center justify-center group"
            >
